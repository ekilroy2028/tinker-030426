...
def test_transaction_total_with_multiple_items():
    burger = FoodItem(name="Spicy Burger", price=10.0, category="Food", popularity_rating=4.5)
    soda = FoodItem(name="Large Soda", price=5.0, category="Drinks", popularity_rating=3.0)
...
def test_filter_by_category_returns_correct_items():
    menu = Menu()
    menu.add_item(FoodItem(name="Large Soda", price=2.99, category="Drinks", popularity_rating=4.0))
    menu.add_item(FoodItem(name="Spicy Burger", price=9.99, category="Food", popularity_rating=4.5))
...
def test_customer_tracks_total_spent():
    ...
    txn = Transaction(items=[FoodItem(name="Burger", price=10.0, category="Food", popularity_rating=4.0)])
